...
export default {
  ...
  config: {
    ...
    customEmoji: {
      ...
      url: 'URL',
      addEmoji: '追加',
      importFromEmojiSets: '自分の絵文字セットからインポート',
      ...
      importFromFileDescription: 'エクスポートしたJSONファイルを読み込んで絵文字を追加します。',
      chooseFile: 'ファイルを選ぶ',
      importFromText: 'テキストからインポート',
      importFromTextDescription:
        '絵文字の名前をキー、画像のURLを値とするJSONを読み込むことができます。',
      importEmoji: 'インポート',
      emojisImported_one: '{{count}}個の絵文字をインポートしました',
      emojisImported_other: '{{count}}個の絵文字をインポートしました',
      failedToImportJSON: 'JSONの読み込みに失敗しました',
      exportToFile: 'ファイルへエクスポート',
      exportToFileDescription:
        '登録中の絵文字を、ここからインポートできるJSONファイルとして保存します。',
      exportEmoji: 'エクスポート',
    },
    mute: {
      mute: 'ミュート',
