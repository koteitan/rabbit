  ...
  config: {
    ...
    customEmoji: {
      ...
      chooseEmojisFromEmojiListDescription:
        '"Choose from emoji sets" lets you pick which emojis to add from the emoji sets (kind:30030) of your emoji list (kind:10030).',
      chooseEmojisFromEmojiList: 'Choose from emoji sets',
      loadingEmojiList: 'Loading...',
