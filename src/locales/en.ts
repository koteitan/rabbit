...
export default {
  ...
  config: {
    ...
    customEmoji: {
      ...
      registeredEmojis: 'Registered custom emojis',
      selectAll: 'Select all',
      deselectAll: 'Deselect all',
      numberOfSelectedEmojis_one: '{{count}}/{{total}} selected',
      numberOfSelectedEmojis_other: '{{count}}/{{total}} selected',
      removeSelectedEmojis_one: 'Remove {{count}} selected',
      removeSelectedEmojis_other: 'Remove {{count}} selected',
      confirmRemoveEmojis_one: 'Remove the {{count}} selected emoji?',
      confirmRemoveEmojis_other: 'Remove the {{count}} selected emojis?',
      createEmoji: 'Create',
      shortcode: 'Name',
      url: 'URL',
      addEmoji: 'Add',
      importFromEmojiSets: 'Import from my emoji sets',
      ...
      duplicatedShortcodes: 'Duplicated names: {{shortcodes}}. The last one wins.',
      cancel: 'Cancel',
      addSelectedEmojis_one: 'Add {{count}}',
      addSelectedEmojis_other: 'Add {{count}}',
      emojiListImported_one: 'Imported {{count}} emoji.',
      emojiListImported_other: 'Imported {{count}} emojis.',
      ...
      importFromFileDescription: 'Load an exported JSON file to add its emojis.',
      chooseFile: 'Choose a file',
      importFromText: 'Import from a text',
      importFromTextDescription:
        'Paste a JSON where the keys are names and the values are image URLs',
      importEmoji: 'Import',
      emojisImported_one: 'Imported {{count}} emoji.',
      emojisImported_other: 'Imported {{count}} emojis.',
      failedToImportJSON: 'Failed to read the JSON',
      exportToFile: 'Export to a file',
      exportToFileDescription:
        'Save the registered emojis as a JSON file which can be imported here.',
      exportEmoji: 'Export',
    },
    mute: {
      mute: 'Mute',
